...
public class Test29 {
    public static void main(String[] args) {
         ...
         * such as to represent MARCH, use 03 and not 3 & to represent 4th day of the month, use 04
         * and not 4. Single digit month and day value are not automatically padded with 0 to convert
         * it to 2 digits.
         *
        ...
        dates.add(LocalDate.parse("2018-7-11")); // RE: DateTimeParseException: '2018-7-11' could not be parsed at index 5
